...
OUT = '/home/ubuntu/.openclaw/workspace-health/output/每日健康记录表_张建来.pdf'
...
def header_block():
    ...
    sub = Paragraph("张建来 · 胰腺癌 (PDAC) Ⅳ期 · 化疗 + 营养支持期", S_SUB)
    info = Table([[
        Paragraph("<b>日期：</b>2026 / __ / __ （星期__）", S_NORM),
        Paragraph("<b>住院第__天</b>", S_NORM),
        Paragraph("<b>化疗 C__ D__</b>", S_NORM),
        Paragraph("<b>床号：</b>05-09", S_NORM),
...
story.append(section_title("当前用药速查", "💊"))
story.append(Spacer(1, 2))
story.append(medication_box())
